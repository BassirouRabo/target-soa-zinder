...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function i() {
            ...
            c = o + (+new Date).toString(32), d = "onmouseenter"in document.documentElement, u = "onfocusin"in document.documentElement, f = {
                ...
                if (t && 3 !== t.nodeType && 8 !== t.nodeType) {
                    for (t[c] ? g = t[c] : (g = l++, t[c] = g, s[g] = {}), p = p || t, o = o.split(" "), y = o.length; y--;)b = o[y], C = m, x = w = !1, "DOMContentLoaded" === b && (b = "ready"), a.domLoaded && "ready" === b && "complete" == t.readyState ? h.call(p, n({type: b})) : (d || (x = f[b], x && (C = function (e) {
                        var t, r;
        ...
        function e(e) {
            var t = e, n, r;
            if (!s(e))for (t = [], n = 0, r = e.length; r > n; n++)t[n] = e[n];
            return t
        }
        ...
        return {isArray: s, toArray: e, each: n, map: r, filter: i, indexOf: o, reduce: a}
        ...
        return f.fn = f.prototype = {
            constructor: f, selector: "", context: null, length: 0, init: function (e, t) {
                ...
                if (a(e)) {
                    ...
                    if (r[1])for (i = l(e, v(t)).firstChild; i;)_.call(n, i), i = i.nextSibling; else {
                ...
                if (t !== !1)for (r = f.unique(n.toArray().concat(f.makeArray(e))), n.length = r.length, i = 0; i < r.length; i++)n[i] = r[i]; else _.apply(n, f.makeArray(e));
                return n
            }, attr: function (e, t) {
                var n = this, r;
        ...
        function t(n) {
            ...
            function h(e, t) {
                var n = H[V], r = H[W], i = H[U], o = H[$], a = t.startContainer, s = t.startOffset, l = t.endContainer, c = t.endOffset;
            ...
            function R(e, t) {
                var n = x(H[U], H[$] - 1), r, i, o, a, s, l = n != H[U];
            ...
            function A(e, t) {
                var n = x(H[V], H[W]), r = n != H[V], i, o, a, s, l;
            ...
            var H = this, L = n.doc, P = 0, O = 1, I = 2, F = !0, z = !1, W = "startOffset", V = "startContainer", U = "endContainer", $ = "endOffset", q = e.extend, j = n.nodeIndex;
            return q(H, {
                startContainer: L,
                startOffset: 0,
                endContainer: L,
        ...
        return function (t, n) {
            ...
            function i(n, i, l) {
                ...
                function h() {
                    f(function () {
                        for (var e = t.styleSheets, n, r = e.length, i; r--;)if (n = e[r], i = n.ownerNode ? n.ownerNode : n.owningElement, i && i.id === m.id)return c(), !0
                    }, h)
                }
                ...
                if (n = e._addCacheSuffix(n), a[n] ? y = a[n] : (y = {
                    ...
                    if (y.status = 1, m = t.createElement("link"), m.rel = "stylesheet", m.type = "text/css", m.id = "u" + o++, m.async = !1, m.defer = !1, v = (new Date).getTime(), "onload"in m && !d())m.onload = h, m.onerror = u; else {
        ...
        var p = c.each, m = c.is, g = c.grep, v = c.trim, y = l.ie, b = /^([a-z0-9],?)+$/i, x = /^[ \t\r\n]*$/;
        return h.prototype = {
            $$: function (e) {
        ...
        return function (e) {
            ...
            function f(e) {
                var n, r, i, o, s, l, c, f, h, p, m, g, v, b, C, w, _, E, N, k = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/, S = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/, T = /[*?+]/;
                if (e)for (e = t(e, ","), y["@"] && (w = y["@"].attributes, _ = y["@"].attributesOrder), n = 0, r = e.length; r > n; n++)if (s = k.exec(e[n])) {
                    ...
                    if (f)for (f = t(f, "|"), i = 0, o = f.length; o > i; i++)if (s = S.exec(f[i])) {
            ...
            function g(e) {
                var t = y[e], n;
                if (t)return t;
                for (n = x.length; n--;)if (t = x[n], t.pattern.test(e))return t
            }

            var v = this, y = {}, b = {}, x = [], C, w, _, E, N, k, S, T, R, A, B, D, M, H = {}, L = {};
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, h = [], p, m, g, v, y, b, x, C, w, _, E, N, k, S, T, R, A, B, D, M, H, L, P, O, I, F = 0, z = t.decode, W, V = n.makeMap("src,href,data,background,formaction,poster"), U = /((java|vb)script|mhtml):/i, $ = /^data:/i;
                    ...
                    if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6])d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), o(d); else if (d = c[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in x, W && H[d] && h.length > 0 && h[h.length - 1].name === d && o(d), !_ || (E = a.getElementRule(d))) {
                            if (N = !0, _ && (T = E.attributes, R = E.attributePatterns), (S = c[8]) ? (y = -1 !== S.indexOf("data-mce-type"), y && b && (N = !1), p = [], p.map = {}, S.replace(P, s)) : (p = [], p.map = {}), _ && !y) {
                                if (A = E.attributesRequired, B = E.attributesDefault, D = E.attributesForced, M = E.removeEmptyAttrs, M && !p.length && (N = !1), D)for (m = D.length; m--;)k = D[m], v = k.name, I = k.value, "{$uid}" === I && (I = "mce_" + F++), p.map[v] = I, p.push({
                                    name: v,
                                    value: I
                                });
                                if (B)for (m = B.length; m--;)k = B[m], v = k.name, v in p.map || (I = k.value, "{$uid}" === I && (I = "mce_" + F++), p.map[v] = I, p.push({
                                    name: v,
                                    value: I
                                }));
                                if (A) {
                        ...
                        w || (S && S.indexOf("/") == S.length - 1 ? N && l.end(d) : h.push({name: d, valid: N}))
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                var v, y, b, x, C, w, _, E, N, k, S, T, R, A = [], B, D, M, H, L, P, O, I;
                if (o = o || {}, h = {}, p = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, S = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, L = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, H = /^[ \t\r\n]+$/, v = new n({
                        ...
                        start: function (e, t, n) {
                            ...
                            if (r = S ? l.getElementRule(t) : {}) {
                                if (T[t] && !B) {
                                    if (n = b.firstChild, n && 3 === n.type)if (i = n.value.replace(R, ""), i.length > 0)n.value = i, n = n.next; else for (o = n.next, n.remove(), n = o; n && 3 === n.type;)i = n.value, o = n.next, (0 === i.length || H.test(i)) && (n.remove(), n = o), n = o;
                                    if (n = b.lastChild, n && 3 === n.type)if (i = n.value.replace(D, ""), i.length > 0)n.value = i, n = n.prev; else for (o = n.prev, n.remove(), n = o; n && 3 === n.type;)i = n.value, o = n.prev, (0 === i.length || H.test(i)) && (n.remove(), n = o), n = o
                                }
                                if (B && L[t] && (B = !1), (r.removeEmpty || r.paddEmpty) && b.isEmpty(O))if (r.paddEmpty)b.empty().append(new e("#text", "3")).value = "\xa0"; else if (!b.attributes.map.name && !b.attributes.map.id)return a = b.parent, T[b.name] ? b.empty().remove() : b.unwrap(), void(b = a);
                                b = b.parent
                            }
                        }
                    ...
                    for (C = 0, w = f.length; w > C; C++)if (N = f[C], N.name in p) {
        ...
        return function (r, i) {
            ...
            function a(t) {
                ...
                n = t.screenX - T, r = t.screenY - R, P = n * k[2] + D, O = r * k[3] + M, P = 5 > P ? 5 : P, O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && k[2] * k[3] !== 0, o && (W(n) > W(r) ? (O = V(P * H), P = V(O / H)) : (P = V(O / H), O = V(P * H))), x.setStyles(_, {
                    ...
                    left: a - n,
                    top: s - r
                }), L || (i.fire("ObjectResizeStart", {target: w, width: D, height: M}), L = !0)
            }
            ...
            function u(e) {
                ...
                }), o = "mousedown" == e.type ? e.target : r.getNode(), o = x.$(o).closest(z ? "table" : "table,img,hr")[0], t(o, U) && (v(), n = r.getStart(!0),
                t(n, o) && t(r.getEnd(!0), o) && (!z || o != n && "IMG" !== n.nodeName)) ? void l(o) : void c()
            }
            ...
            function h(e) {
                ...
                for (r in N)if (o = N[r], a = t.offsetWidth * o[0], s = t.offsetHeight * o[1], W(a - c) < 8 && W(s - u) < 8) {
                    k = o;
                    break
                }
            ...
            function p(e) {
                var t = e.srcElement;
                if (t != w) {
                    if (i.fire("ObjectSelected", {target: t}), m(), 0 === t.id.indexOf("mceResizeHandle"))return void(e.returnValue = !1);
            ...
            var x = i.dom, C = t.each, w, _, E, N, k, S, T, R, A, B, D, M, H, L, P, O, I = i.getDoc(), F = document, z = n.ie && n.ie < 11, W = Math.abs, V = Math.round, U = i.getBody(), $, q;
            N = {nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1]};
        ...
        function n(n) {
            ...
            this.getBookmark = function (e, i) {
                ...
                if (l = n.getRng(), u = r.uniqueId(), d = n.isCollapsed(), m = "overflow:hidden;line-height:0px", l.duplicate || l.item) {
                    if (l.item)return h = l.item(0), f = h.nodeName, {name: f, index: o(f, h)};
                    c = l.duplicate();
                    try {
                    ...
                    if (h = n.getNode(), f = h.nodeName, "IMG" == f)return {name: f, index: o(f, h)};
        ...
        return function (a) {
            ...
            function b(t, n, r) {
                ...
                if (u)if (r)r.nodeType ? (h = q.createRng(), h.setStartBefore(r), h.setEndAfter(r), l(L(h, c), null, !0)) : l(r, null, !0); else if (m && u.inline && !q.select("td.mce-item-selected,th.mce-item-selected").length)V("apply", t, n); else {
            ...
            function x(e, t, n, r) {
                function i(e) {
                    var n, r, o, a, s;
                    if (1 === e.nodeType && ie(e) && (a = b, b = "true" === ie(e), s = !0), n = ce(e.childNodes), b && !s)for (r = 0, o = h.length; o > r && !O(h[r], t, e, e); r++);
                    if (m.deep && n.length) {
                ...
                function s(e, n, r, i) {
                    ...
                    if (e) {
                        for (u = e.parentNode, o = n.parentNode; o && o != u; o = o.parentNode) {
                            for (a = q.clone(o, ee), c = 0; c < h.length; c++)if (O(h[c], t, a, a)) {
                                a = 0;
                                break
                            }
            ...
            function w(e, t, n, r) {
                function i(e, t, i) {
                    ...
                    } else for (l = 0; l < s.length; l++)if ("attributes" === i ? q.getAttrib(e, s[l]) : A(e, s[l]))return t;
                    return t
                }

                var o = p(t), a, s, l;
                if (o && e)for (s = 0; s < o.length; s++)if (a = o[s], T(e, a) && i(e, a, "attributes") && i(e, a, "styles")) {
                    if (l = a.classes)for (s = 0; s < l.length; s++)if (!q.hasClass(e, l[s]))return;
                    return a
                }
            }
            ...
            function N(e) {
                var t = p(e), n, r, i, o, a;
                if (t)for (n = j.getStart(), r = u(n), o = t.length - 1; o >= 0; o--) {
                    if (a = t[o].selector, !a || t[o].defaultBlock)return te;
                    for (i = r.length - 1; i >= 0; i--)if (q.is(r[i], a))return te
                }
                return ee
            }
            ...
            function L(t, n, r) {
                function i(e) {
                    ...
                    for (; ;) {
                        ...
                        for (o = i[a]; o; o = o[a])if (!se(o) && !M(o) && !t(o))return i;
                        if (i.parentNode == s) {
                            r = i;
                            break
                        }
                ...
                function c(t, n, i) {
                    ...
                    for (s = new e(t, q.getParent(t, G) || a.getBody()); l = s[i ? "prev" : "next"]();)if (3 === l.nodeType) {
                ...
                function d(e, r) {
                    var i, o, a, s;
                    for (3 == e.nodeType && 0 === e.nodeValue.length && e[r] && (e = e[r]), i = u(e), o = 0; o < i.length; o++)for (a = 0; a < n.length; a++)if (s = n[a], !("collapsed"in s && s.collapsed !== t.collapsed) && q.is(i[o], s.selector))return i[o];
                    return e
                }
                ...
                function f(e, t) {
                    ...
                    if (n[0].wrapper || (r = q.getParent(e, n[0].block, i)), r || (r = q.getParent(3 == e.nodeType ? e.parentNode : e, function (e) {
                            return e != i && s(e)
                        })), r && n[0].wrapper && (r = u(r, "ul,ol").reverse()[0] || r), !r)for (r = e; r[t] && !G(r[t]) && (r = r[t], !R(r, "br")););
                    return r || e
                }
            ...
            function O(e, t, n, r) {
                ...
                if ("all" != e.remove)for (le(e.styles, function (i, o) {
                ...
                }), o = q.getAttribs(n), i = 0; i < o.length; i++)if (0 !== o[i].nodeName.indexOf("_"))return ee;
            ...
            function F(e, t, n) {
                if (e)for (t = t ? "nextSibling" : "previousSibling", e = n ? e : e[t]; e; e = e[t])if (1 == e.nodeType || !M(e))return e
            }
            ...
            function V(t, n, r, i) {
                function o(e) {
                    var t = q.create("span", {id: g, "data-mce-bogus": !0, style: v ? "color:red" : ""});
                ...
                function d(e, t) {
                    var n, r;
                    if (e)r = j.getRng(!0), l(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), q.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === Q && (n.deleteData(0, 1), r.startContainer == n && r.startOffset > 0 && r.setStart(n, r.startOffset - 1), r.endContainer == n && r.endOffset > 0 && r.setEnd(n, r.endOffset - 1)), q.remove(e, 1)), j.setRng(r); else if (e = c(j.getStart()), !e)for (; e = q.get(g);)d(e, !1)
                }
                ...
                function h() {
                    ...
                    if (d)if (c)l = j.getBookmark(), e.collapse(!0), e = L(e, p(n), !0), e = K.split(e), x(n, r, e), j.moveToBookmark(l); else {
                ...
                a._hasCaretEvents || (ae = function () {
                    var e = [], t;
                    if (l(c(j.getStart()), e))for (t = e.length; t--;)q.setAttrib(e[t], "data-mce-bogus", "1")
                }, oe = function (e) {
                    var t = e.keyCode;
            ...
            function U(t) {
                ...
                if ((t.startContainer != t.endContainer || !c(t.startContainer.childNodes[t.startOffset])) && (3 == n.nodeType && r >= n.nodeValue.length && (r = J(n), n = n.parentNode, i = !0), 1 == n.nodeType))for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, q.getParent(n, q.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())if (3 == a.nodeType && !M(a))return l = q.create("a", {"data-mce-bogus": "all"}, Q), a.parentNode.insertBefore(l, a), t.setStart(a, 0), j.setRng(t), void q.remove(l)
            }
        ...
        var i = n.trim, o;
        return o = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function (e) {
            function n() {
                var t = e.getContent({
                    format: "raw",
                    no_events: 1
            ...
            return e.on("init", function () {
                ...
                data: u, typing: !1, beforeChange: function () {
                    ...
                    var l = {level: t, lastLevel: s, originalEvent: r};
        ...
        return function (i) {
            function o(o) {
                ...
                function b(e) {
                    var t = B, n, i, o, s = u.getTextInlineElements();
                    if (e || "TABLE" == F ? (n = a.create(e || W), v(n)) : n = M.cloneNode(!1), o = n, l.keep_styles !== !1)do if (s[t.nodeName]) {
                ...
                if (T = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(T), B = T.startContainer, D = T.startOffset, W = (l.force_p_newlines ? "p" : "") || l.forced_root_block, W = W ? W.toUpperCase() : "", H = a.doc.documentMode, L = o.shiftKey, 1 == B.nodeType && B.hasChildNodes() && (V = D > B.childNodes.length - 1, B = B.childNodes[Math.min(D, B.childNodes.length - 1)] || B, D = V && 3 == B.nodeType ? B.nodeValue.length : 0), A = N(B)) {
                        ...
                        W && M === i.getBody() || (W = W || "P", x() ? S() : x(!0) ? (P = M.parentNode.insertBefore(b(), M), p(P), g(M)) : (R = T.cloneRange(), R.setEndAfter(M), O = R.extractContents(), E(O), P = O.firstChild, a.insertAfter(O, M), m(P), k(M), a.isEmpty(M) && y(M), a.isEmpty(P) ? (a.remove(P), S()) : g(P)), a.setAttrib(P, "id", ""), i.fire("NewBlock", {newBlock: P}), c.add())
                    }
                }
            }
        ...
        return function (e) {
            function t() {
                ...
                if (x = n.forced_root_block, t && 1 === t.nodeType && x) {
                    ...
                    for (t = s.firstChild, b = s.nodeName.toLowerCase(); t;)if ((3 === t.nodeType || 1 == t.nodeType && !a[t.nodeName]) && o.isValidChild(b, x.toLowerCase())) {
        ...
        return function (r) {
            function v(e, t, n, i) {
                ...
                return c ? (r.fire("ExecCommand", {command: e, ui: t, value: n}), !0) : !1
            }
            ...
            function T(e, n) {
                M.toggle(e, n ? {value: n} : t), r.nodeChanged()
            }
            ...
            var B, D, M, H = {state: {}, exec: {}, value: {}}, L = r.settings, P;
            r.on("PreInit", function () {
                ...
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    function c(e) {
                        if (_)for (x = e.firstChild; x; x = x.walk(!0))N[x.name] && x.attr("data-mce-new", "true")
                    }
                    ...
                    var k = b.startContainer || (b.parentElement ? b.parentElement() : null), S = r.getBody();
                    ...
                    var T = {context: p.nodeName.toLowerCase(), data: E};
                    if (g = d.parse(o, T), c(g), x = g.lastChild, "mce_marker" == x.attr("id"))for (y = x, x = x.prev; x; x = x.walk(!0))if (3 == x.type || !B.isBlock(x.name)) {
                    ...
                    var r;
                    "string" == typeof n && (n = {href: n}), r = B.getParent(D.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || M.remove("link"), n.href && M.apply("link", n, r)
                }, selectAll: function () {
                    var e = B.getRoot(), t;
                    ...
                    function i() {
                        for (var e = new a(h, v), t, n = r.schema.getNonEmptyElements(); t = e.next();)if (n[t.nodeName.toLowerCase()] || t.length > 0)return !0
                    }
            ...
            init: function (e) {
                ...
                for (t = t || this._selectors, n = 0, r = t.length; r > n; n++) {
                    for (a = t[n], o = a.length, p = e, h = 0, i = o - 1; i >= 0; i--)for (c = a[i]; p;) {
                        if (c.psuedo)for (f = p.parent().items(), u = d = f.length; u-- && f[u] !== p;);
        ...
        return function (e) {
            ...
            function r(e) {
                for (var t, r = e || x; r = r.parentNode;)if (t = n(r))return t
            }
            ...
            function y(e) {
                e = e || {}, C.fire("click", {target: x, aria: e})
            }
        ...
        function u(e) {
            function t(t, n) {
                for (var r, i = 0; i < g.length; i++)if (g[i] != e)for (r = g[i].parent(); r && (r = r.parent());)r == e && g[i].fixed(t).moveBy(0, n).repaint()
            }
        ...
        function d(e, t) {
            ...
            if (e)v.push(t); else for (n = v.length; n--;)v[n] === t && v.splice(n, 1);
            if (v.length)for (n = 0; n < v.length; n++)v[n].modal && (r++, o = v[n]), v[n].getEl().style.zIndex = r, v[n].zIndex = r, r++;
        ...
        function l(e) {
            for (var t = 0; t < u.length; t++)if (u[t]._fullscreen)return;
        ...
        var u = [], d = "", f = e.extend({
            ...
            fullscreen: function (e) {
                ...
                if (e != t._fullscreen)if (r(window).on("resize", function () {
                        var e;
                        if (t._fullscreen)if (a)t._timer || (t._timer = setTimeout(function () {
        ...
        return function (s) {
            ...
            function p() {
                function r(e) {
                    ...
                    for (e = e; e != n && !t[e.nodeName]; e = e.parentNode)if (e.nextSibling)return !1;
                    return !0
                }

                function i(e, t) {
                    var n;
                    for (n = e.nextSibling; n && n != t; n = n.nextSibling)if ((3 != n.nodeType || 0 !== j.trim(n.data).length) && n !== t)return !1;
                    return n === t
                }
                ...
                function c(e, n) {
                    ...
                    if (u = e.startContainer, d = e.startOffset, 3 == u.nodeType)if (n) {
                ...
                b || (x = !0, b = function () {
                    ...
                    var t = e.keyCode == Y, n = e.ctrlKey || e.metaKey;
            ...
            function m() {
                function e(e) {
                    var t = G.create("body"), n = e.cloneContents();
                    return t.appendChild(n), X.serializer.serialize(t, {format: "html"})
                }
                ...
                s.on("keydown", function (e) {
                    if (!u(e) && e.keyCode === K) {
                        ...
                        if (X.isCollapsed() && 0 === X.getRng(!0).startOffset) {
                            var t = X.getNode(), n = t.previousSibling;
            ...
            function E() {
                c() > 7 || (l("RespectVisibilityInDesign", !0), s.contentStyles.push(".mceHideBrInPre pre br {display: none}"), G.addClass(s.getBody(), "mceHideBrInPre"), Q.addNodeFilter("pre", function (e) {
                    for (var t = e.length, n, i, o, a; t--;)for (n = e[t].getAll("br"), i = n.length; i--;)o = n[i], a = o.prev, a && 3 === a.type && "\n" != a.value.charAt(a.value - 1) ? a.value += "\n" : o.parent.insert(new r("#text", 3), o, !0).value = "\n"
            ...
            function T() {
                function e() {
                    q(G.select("a"), function (e) {
                        var t = e.parentNode, n = G.getRoot();
                        if (t.lastChild === e) {
                            for (; t && !G.isBlock(t);) {
                                if (t.parentNode.lastChild !== t || t === n)return;
                                t = t.parentNode
                            }
                            G.add(t, "br", {"data-mce-bogus": 1})
                        }
                    })
                }
            ...
            var q = a.each, j = s.$, K = e.BACKSPACE, Y = e.DELETE, G = s.dom, X = s.selection, J = s.settings, Q = s.parser, Z = s.serializer, ee = o.gecko, te = o.ie, ne = o.webkit, re = "data:text/mce-internal,", ie = te ? "Text" : "URL";
        ...
        return function (r) {
            ...
            var c = {};
            return r = t.extend({credentials: !1, handler: s}, r), {upload: l}
        }
    }), r(xe, [ve], function (e) {
        function t(t) {
            return new e(function (e) {
            ...
            function a(a) {
                function l(e, t) {
                    ...
                    return 0 === e.src.indexOf("blob:") ? (a = o.getByUri(e.src), void(a && t({
                        ...
                        return e.base64() === r
                    }), void(a ? t({image: e, blobInfo: a}) : n.uriToBlob(e.src).then(function (n) {
                        var a = "blobid" + i++, s = o.create(a, n, r);
                        o.add(s), t({image: e, blobInfo: s})
                    })))
                }
        ...
        return function (i) {
            ...
            }), {blobCache: p, uploadImages: c, uploadImagesAuto: u, scanForImages: d, destroy: f}
        }
        ...
        var S = e.DOM, T = r.ThemeManager, R = r.PluginManager, A = w.extend, B = w.each, D = w.explode, M = w.inArray, H = w.trim, L = w.resolve, P = g.Event, O = C.gecko, I = C.ie;
        return k.prototype = {
            render: function () {
                function e() {
                ...
                function t() {
                    ...
                    w.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), B(r.external_plugins, function (e, t) {
                        ...
                        if (e = H(e), e && !R.urls[e])if ("-" == e.charAt(0)) {
                        ...
                        } else R.load(e, {prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js"})
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v = [], y, b, x, C, w, _, E, N, k, S, T, R, A, B, D, M, H, L, P, O, I, F, z = Math.max, W = Math.min;
        ...
        return e.extend({
            recalc: function (e) {
                var t = e.settings, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, x, C, w, _, E = [], N = [], k, S, T, R, A, B;
                ...
                for (f = 0; n > f; f++)for (d = 0; r > d && (u = i[f * r + d], u); d++)c = u.layoutRect(), k = c.minW, S = c.minH, E[d] = k > E[d] ? k : E[d], N[f] = S > N[f] ? S : N[f];
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    if (H)for (d = 0; d < H.length; d++)M += H[d]; else M = r;
                    var L = T / M;
        ...
        function n(e, t, n) {
            return {x: e.x - t, y: e.y - n, w: e.w + 2 * t, h: e.h + 2 * n}
        }
        ...
        return {inflate: n, relativePosition: e, findBestRelativePosition: t, intersect: r, clamp: i}
